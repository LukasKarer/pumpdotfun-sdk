...
class PumpFunSDK {
    ...
    async createAndBuy(creator, mint, createTokenMetadata, buyAmountSol, slippageBasisPoints = 500n, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY, feeOptions, priorityFees) {
        ...
        let createResults = await (0, util_1.sendTx)(this.connection, newTx, creator.publicKey, [creator, mint], commitment, finality, feeOptions, priorityFees);
        return createResults;
    }
    async buy(buyer, mint, buyAmountSol, slippageBasisPoints = 500n, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY, feeOptions, priorityFees) {
        let buyTx = await this.getBuyInstructionsBySolAmount(buyer.publicKey, mint, buyAmountSol, slippageBasisPoints, commitment);
        let buyResults = await (0, util_1.sendTx)(this.connection, buyTx, buyer.publicKey, [buyer], commitment, finality, feeOptions, priorityFees);
        return buyResults;
    }
    async sell(seller, mint, sellTokenAmount, slippageBasisPoints = 500n, commitment = util_1.DEFAULT_COMMITMENT, finality = util_1.DEFAULT_FINALITY, feeOptions, priorityFees) {
        ...
        let sellResults = await (0, util_1.sendTx)(this.connection, sellTx, seller.publicKey, [seller], commitment, finality, feeOptions, priorityFees);
        return sellResults;
    }
