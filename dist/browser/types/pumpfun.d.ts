...
import { CreateTokenMetadata, feeOptions, PriorityFee, PumpFunEventHandlers, PumpFunEventType, TransactionResult } from "./types";
...
export declare class PumpFunSDK {
    ...
    createAndBuy(creator: Keypair, mint: Keypair, createTokenMetadata: CreateTokenMetadata, buyAmountSol: bigint, slippageBasisPoints: bigint | undefined, commitment: Commitment | undefined, finality: Finality | undefined, feeOptions: feeOptions, priorityFees?: PriorityFee): Promise<TransactionResult>;
    buy(buyer: Keypair, mint: PublicKey, buyAmountSol: bigint, slippageBasisPoints: bigint | undefined, commitment: Commitment | undefined, finality: Finality | undefined, feeOptions: feeOptions, priorityFees?: PriorityFee): Promise<TransactionResult>;
    sell(seller: Keypair, mint: PublicKey, sellTokenAmount: bigint, slippageBasisPoints: bigint | undefined, commitment: Commitment | undefined, finality: Finality | undefined, feeOptions: feeOptions, priorityFees?: PriorityFee): Promise<TransactionResult>;
