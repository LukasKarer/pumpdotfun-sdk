import { ComputeBudgetProgram, SendTransactionError, SystemProgram, Transaction, TransactionMessage, VersionedTransaction, } from "@solana/web3.js";
...
export async function sendTx(connection, tx, payer, signers, commitment = DEFAULT_COMMITMENT, finality = DEFAULT_FINALITY, feeOptions, priorityFees) {
